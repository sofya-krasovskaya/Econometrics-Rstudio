...
В рамках работы проведены анализ временной структуры ряда, проверка его свойств и подбор модели прогнозирования с учетом сезонности.

Для построения прогноза использован автоматический подбор ARIMA-модели. В результате выбрана модель **ARIMA(2,2,1)(0,0,2)[12]**.

Качество модели оценено с помощью показателей:
...
*Figures and tables will be added here.*
